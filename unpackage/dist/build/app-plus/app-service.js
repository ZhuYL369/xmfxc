...
Z(z[3])
Z(z[3])
Z([3,'slide_list data-v-5c888a5e'])
...
Z(z[3])
Z([3,'now-message-info data-v-5c888a5e'])
...
var x=['./components/m-icon/m-icon.wxml','./components/m-input.wxml','./components/m-search/m-search.wxml','./pages/login/login.wxml','./pages/pwd/pwd.wxml','./pages/reg/reg.wxml','./pages/tabbar/tabbar-1/home.wxml','./pages/tabbar/tabbar-2/order.wxml','./pages/tabbar/tabbar-3/my.wxml','./pages/user/user.wxml','./pages/xmfauth/xmfauth.wxml'];d_[x[0]]={}
...
var cF=_mz(z,'m-icon',['bind:__l',2,'bind:click',1,'color',2,'data-event-opts',3,'type',4,'vueId',5],[],e,s,gg)
_(oD,cF)
}
var fE=_v()
_(xC,fE)
if(_oz(z,8,e,s,gg)){fE.wxVkey=1
var hG=_mz(z,'m-icon',['bind:__l',9,'bind:click',1,'data-event-opts',2,'style',3,'type',4,'vueId',5],[],e,s,gg)
_(fE,hG)
}
oD.wxXCkey=1
oD.wxXCkey=3
...
var eN=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:__l',1,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(tM,eN)
var bO=_mz(z,'m-input',['displayable',-1,'bind:__l',9,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(tM,bO)
_(r,tM)
return r
}
...
_(fS,oV)
var cW=_mz(z,'m-input',['clearable',-1,'bind:__l',22,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(fS,cW)
_(r,fS)
return r
}
...
var e2=_mz(z,'m-search',['bind:__l',2,'bind:search',1,'button',2,'class',3,'data-event-opts',4,'mode',5,'vueId',6],[],e,s,gg)
_(aZ,e2)
var b3=_v()
_(aZ,b3)
var o4=function(o6,x5,f7,gg){
var h9=_mz(z,'view',['bindtap',13,'bindtouchend',1,'bindtouchmove',2,'bindtouchstart',3,'class',4,'data-event-opts',5,'style',6],[],o6,x5,gg)
var cAB=_mz(z,'view',['bindtap',20,'class',1,'data-event-opts',2,'hoverClass',3,'style',4],[],o6,x5,gg)
var oBB=_v()
_(cAB,oBB)
if(_oz(z,25,o6,x5,gg)){oBB.wxVkey=1
}
oBB.wxXCkey=1
_(h9,cAB)
var o0=_v()
_(h9,o0)
if(_oz(z,26,o6,x5,gg)){o0.wxVkey=1
}
o0.wxXCkey=1
_(f7,h9)
return f7
...
__wxAppCode__['app.json']={"pages":["pages/tabbar/tabbar-1/home","pages/tabbar/tabbar-2/order","pages/tabbar/tabbar-3/my","pages/login/login","pages/reg/reg","pages/pwd/pwd","pages/user/user","pages/xmfauth/xmfauth"],"subPackages":[],"window":{"navigationBarTextStyle":"black","navigationBarTitleText":"小蜜蜂洗车","navigationBarBackgroundColor":"#F8F8F8","backgroundColor":"#F8F8F8"},"tabBar":{"borderStyle":"black","backgroundColor":"#333","color":"#8F8F94","selectedColor":"#f33e54","list":[{"pagePath":"pages/tabbar/tabbar-1/home","iconPath":"static/img/tabbar/home.png","selectedIconPath":"static/img/tabbar/homeactive.png","text":"首页"},{"pagePath":"pages/tabbar/tabbar-2/order","iconPath":"static/img/tabbar/order.png","selectedIconPath":"static/img/tabbar/orderactive.png","text":"订单"},{"pagePath":"pages/tabbar/tabbar-3/my","iconPath":"static/img/tabbar/me.png","selectedIconPath":"static/img/tabbar/meactive.png","text":"个人中心"}]},"nvueCompiler":"weex","splashscreen":{"alwaysShowBeforeRender":true,"autoclose":false},"appname":"小蜜蜂洗车uin","compilerVersion":"2.0.7","usingComponents":{}};
...
__wxAppCode__['pages/tabbar/tabbar-2/order.json']={"usingComponents":{"m-search":"/components/m-search/m-search"}};
...
__wxAppCode__['pages/xmfauth/xmfauth.json']={"navigationBarTitleText":"小蜜粉认证","usingComponents":{}};
__wxAppCode__['pages/xmfauth/xmfauth.wxml']=$gwx('./pages/xmfauth/xmfauth.wxml');



define('common/main.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["common/main"],{"0389":function(n,t,o){},"2c99":function(n,t,o){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var u={onLaunch:function(){},onShow:function(){},onHide:function(){}};t.default=u},"79fd":function(n,t,o){"use strict";var u=o("0389"),e=o.n(u);e.a},a89f:function(n,t,o){"use strict";o.r(t);var u=o("2c99"),e=o.n(u);for(var c in u)"default"!==c&&function(n){o.d(t,n,function(){return u[n]})}(c);t["default"]=e.a},e719:function(n,t,o){"use strict";o.r(t);var u=o("a89f");for(var e in u)"default"!==e&&function(n){o.d(t,n,function(){return u[n]})}(e);o("79fd");var c,a,f=o("2877"),r=Object(f["a"])(u["default"],c,a,!1,null,null,null);t["default"]=r.exports}},[["d7c1","common/runtime","common/vendor"]]]);
});
...
(function (e) {
  function t(t) {
    for (var r, o, i = t[0], c = t[1], l = t[2], s = 0, m = []; s < i.length; s++) {
  ...
  c.e = function (e) {
    ...
    o[e] ? t.push(o[e]) : 0 !== o[e] && n[e] && t.push(o[e] = new Promise(function (t, n) {
      ...
      for (i = 0; i < m.length; i++) {
        l = m[i], s = l.getAttribute("data-href");
        if (s === r || s === a) return t();
      }
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/m-icon/m-icon"], {
  "0ec0": function ec0(n, t, e) {},
  "4bbb": function bbb(n, t, e) {
    "use strict";
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push(['components/m-icon/m-icon-create-component', {
  'components/m-icon/m-icon-create-component': function componentsMIconMIconCreateComponent(module, exports, __webpack_require__) {
    __webpack_require__('6e42')['createComponent'](__webpack_require__("93e3"));
  }
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/m-input"], {
  ...
  "824d": function d(t, n, e) {
    ...
    var u = function u() {
      return e.e("components/m-icon/m-icon").then(e.bind(null, "93e3"));
    },
        i = {
      components: {
        mIcon: u
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push(['components/m-input-create-component', {
  'components/m-input-create-component': function componentsMInputCreateComponent(module, exports, __webpack_require__) {
    __webpack_require__('6e42')['createComponent'](__webpack_require__("4fdb"));
  }
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/m-search/m-search"], {
    ...
    var n = {
      ...
      methods: {
        ...
        search: function search() {
          console.log(this.inputVal, " at components\\m-search\\m-search.vue:69"), this.$emit("search", this.inputVal);
        }
      },
      watch: {
  ...
  "16a8": function a8(t, e, a) {
    ...
    a("07a4");
    var s = a("2877"),
        c = Object(s["a"])(i["default"], n["a"], n["b"], !1, null, "5cb9bdd0", null);
    e["default"] = c.exports;
  },
  "19c9": function c9(t, e, a) {
    "use strict";
  ...
  "61ab": function ab(t, e, a) {},
  "86a4": function a4(t, e, a) {
    "use strict";
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/tabbar/tabbar-1/home"],{"0c3e":function(t,n,o){"use strict";o.r(n);var i=o("3786"),e=o.n(i);for(var a in i)"default"!==a&&function(t){o.d(n,t,function(){return i[t]})}(a);n["default"]=e.a},3786:function(t,n,o){"use strict";(function(t){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var o,i="",e="",a="",s=!1,c={data:function(){return{online:"上线",mapheight:"",mapwidth:"",title:"map",latitude:39.909,longitude:116.39742,covers:[{latitude:0,longitude:0,iconPath:"../../../static/dingwei.png"}],controlsdata:[{id:1,position:{left:5,top:520,width:40,height:40},iconPath:"../../../static/weizhi.png",clickable:!0},{id:2,position:{left:0,top:0,width:0,height:0},iconPath:"",clickable:!0}]}},methods:{dingwei:function(n){var o=this;1==n.controlId&&t.getLocation({type:"gcj02",success:function(t){o.longitude=t.longitude,o.latitude=t.latitude,o.covers[0].latitude=t.latitude,o.covers[0].longitude=t.longitude}}),2==n.controlId&&this.toonline(n)},toonline:function(n){var e=this;this.latitude,this.longitude;if(t.showLoading({title:"操作执行中，请稍等...",mask:!0}),1==o.onlines){var a=this.webUrl+"/Washapp/Main/offline";t.request({url:a,method:"POST",header:{"Content-Type":"application/x-www-form-urlencoded"},dataType:"json",data:{user:i},success:function(n){0==n.data.code?(t.showToast({icon:"success",title:n.data.msg}),o.onlines=!1,e.controlsdata[1].iconPath="../../../static/start.png"):t.showToast({icon:"none",title:n.data.msg})},fail:function(n){t.showModal({title:"错误",content:JSON.stringify(n)})},complete:function(n){t.hideLoading()}})}else{a=this.webUrl+"/Washapp/Main/getouth";t.request({url:a,method:"POST",dataType:"json",header:{"Content-Type":"application/x-www-form-urlencoded"},data:{user:i},success:function(n){if(9!=n.data.code){if(3!=n.data.code)return t.showToast({title:n.data.msg,icon:"none"}),!1;s=!0,o.Tostart()}},fail:function(n){t.showToast({title:"信息获取错误："+JSON.stringify(n)})},complete:function(n){t.hideLoading()}})}},Tostart:function(){if(s){var n=o.webUrl+"/Washapp/Main/online";t.request({url:n,method:"POST",header:{"Content-Type":"application/x-www-form-urlencoded"},dataType:"json",data:{user:i,longitude:e,latitude:a},success:function(n){0==n.data.code?(t.showToast({icon:"success",title:n.data.msg}),o.onlines=!0,o.controlsdata[1].iconPath="../../../static/onstart.png"):t.showToast({icon:"none",title:n.data.msg})},fail:function(n){t.showModal({title:"错误",content:JSON.stringify(n)})}})}}},onShow:function(){var n=this,e=t.getSystemInfoSync();this.mapheight=e.windowHeight,this.mapwidth=e.windowWidth;var a={id:2,position:{left:100,top:455,width:160,height:50},iconPath:"../../../static/start.png",clickable:!0};n.controlsdata[0].position.top=e.windowHeight-40,a.position.top=e.windowHeight-60,a.position.left=e.windowWidth/2-a.position.width/2,a,i=!1;try{var s=t.getStorageSync("user");s&&(!0,i=s)}catch(d){return t.showToast({title:"获取用户信息错误:"+JSON.stringify(d)}),!1}if(i){var c=this.webUrl+"/Washapp/Main/getstate";i&&t.request({url:c,method:"POST",header:{"Content-Type":"application/x-www-form-urlencoded"},dataType:"json",data:{user:i},success:function(t){1==t.data.code&&(!0,a.iconPath="../../../static/onstart.png",n.controlsdata.pop(),n.controlsdata.push(a),o.onlines=!0),0==t.data.code&&(!1,a.iconPath="../../../static/start.png",n.controlsdata.pop(),n.controlsdata.push(a),o.onlines=!1)},fail:function(n){t.showModal({title:"错误",content:JSON.stringify(n)})}})}},onLoad:function(n){o=this;var i=this;t.getLocation({type:"gcj02",success:function(t){i.latitude=t.latitude,i.longitude=t.longitude,i.covers[0].latitude=t.latitude,i.covers[0].longitude=t.longitude,a=t.latitude,e=t.longitude},fail:function(n){t.showModal({title:"错误",content:"error: "+JSON.stringify(n)})}})},onReady:function(){}};n.default=c}).call(this,o("6e42")["default"])},"8d6a":function(t,n,o){"use strict";var i=function(){var t=this,n=t.$createElement;t._self._c},e=[];o.d(n,"a",function(){return i}),o.d(n,"b",function(){return e})},"93d1":function(t,n,o){"use strict";o.r(n);var i=o("8d6a"),e=o("0c3e");for(var a in e)"default"!==a&&function(t){o.d(n,t,function(){return e[t]})}(a);o("e0e2");var s=o("2877"),c=Object(s["a"])(e["default"],i["a"],i["b"],!1,null,null,null);n["default"]=c.exports},d877:function(t,n,o){},e0e2:function(t,n,o){"use strict";var i=o("d877"),e=o.n(i);e.a}},[["58f0","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/tabbar/tabbar-2/order"],{"0737":function(t,e,i){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},s=[];i.d(e,"a",function(){return a}),i.d(e,"b",function(){return s})},"0d6c":function(t,e,i){},"0fb5":function(t,e,i){"use strict";var a=i("0d6c"),s=i.n(a);s.a},"9fe9":function(t,e,i){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=function(){return i.e("components/m-search/m-search").then(i.bind(null,"16a8"))},s={components:{mSearch:a},name:"slide-list",computed:{Screen_width:function(){return t.getSystemInfoSync().windowWidth}},data:function(){return{img:"../../../static/slide-list/qr_code.png",visible:!1,start_slide_x:0,btnWidth:0,startX:0,LastX:0,startTime:0,screenName:"",list:[{id:1,surname:"24",name:"订单编号:2019071311542345",dateTime:"2019-03-18",remarks:"XXXXXXXXXXXXXXXXXXX公司",isShare:!0,slide_x:0},{id:2,surname:"05",name:"李二",dateTime:"2019-03-17",remarks:"XXXXXXXXXXXXXXXXXXX公司",isShare:!1,slide_x:0},{id:3,surname:"21",name:"王五",dateTime:"2019-03-18",remarks:"XXXXXXXXXXXXXXXXXXX公司",isShare:!0,slide_x:0},{id:4,surname:"18",name:"李珊珊",dateTime:"2019-03-18",remarks:"XXXXXXXXXXXXXXXXXXX公司",isShare:!0,slide_x:0}],btuBottom:"0",secondHeight:""}},onShow:function(){var e=this,i=t.getSystemInfoSync();this.secondHeight=i.windowHeight,t.onWindowResize(function(i){i.size.windowHeight<e.secondHeight&&t.hideTabBar({animation:!1}),i.size.windowHeight>420&&t.showTabBar({animation:!1})})},methods:{cancelEvent:function(){this.visible=!1},search:function(t,e){this.screenName=t,console.log("点击搜索"," at pages\\tabbar\\tabbar-2\\order.vue:144")},addCustomer:function(){console.log("点击添加按钮"," at pages\\tabbar\\tabbar-2\\order.vue:147")},getDetail:function(t){console.log("查看详情"," at pages\\tabbar\\tabbar-2\\order.vue:150"),console.log(JSON.stringify(t)," at pages\\tabbar\\tabbar-2\\order.vue:151")},touchStart:function(e,i){var a=this;this.startTime=e.timeStamp,this.start_slide_x=this.list[i].slide_x,t.createSelectorQuery().selectAll(".group-btn").boundingClientRect().exec(function(t){null!=t[0]&&(a.btnWidth=-1*t[0][i].width)}),this.startX=e.touches[0].pageX,this.lastX=this.startX,this.list.forEach(function(t,e){e!==i&&(t.slide_x=0)})},touchMove:function(t,e){var i=t.touches[0].pageX,a=i-this.lastX,s=this.list[e].slide_x+a;s<=0&&s>=this.btnWidth&&(this.list[e].slide_x=s),this.lastX=i},touchEnd:function(t,e){var i=10,a=t.timeStamp,s=this.startX-this.lastX;Math.abs(a-this.startTime)>200&&(i=this.btnWidth/-2),this.list[e].slide_x=s>i?this.btnWidth:s<-1*i?0:this.start_slide_x},recover:function(t){this.list[t].slide_x=0},top:function(t){console.log("点击分享"," at pages\\tabbar\\tabbar-2\\order.vue:215"),this.visible?this.visible=!1:this.visible=!0},removeM:function(e,i){var a=this;console.log("点击删除"," at pages\\tabbar\\tabbar-2\\order.vue:225"),t.showModal({title:"",content:"确定要删除该信息吗？",confirmText:"删除",confirmColor:"#ff3b32",success:function(i){i.confirm?(console.log("用户点击确定"," at pages\\tabbar\\tabbar-2\\order.vue:233"),a.list.splice(e,1),t.showToast({icon:"success",title:"操作成功!",duration:2e3})):i.cancel&&console.log("用户点击取消"," at pages\\tabbar\\tabbar-2\\order.vue:241")}})}}};e.default=s}).call(this,i("6e42")["default"])},adbc:function(t,e,i){"use strict";i.r(e);var a=i("0737"),s=i("d2eb");for(var n in s)"default"!==n&&function(t){i.d(e,t,function(){return s[t]})}(n);i("0fb5");var o=i("2877"),r=Object(o["a"])(s["default"],a["a"],a["b"],!1,null,"5c888a5e",null);e["default"]=r.exports},d2eb:function(t,e,i){"use strict";i.r(e);var a=i("9fe9"),s=i.n(a);for(var n in a)"default"!==n&&function(t){i.d(e,t,function(){return a[t]})}(n);e["default"]=s.a}},[["7d83","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/tabbar/tabbar-3/my"],{"200b":function(n,t,e){"use strict";var a=function(){var n=this,t=n.$createElement;n._self._c},o=[];e.d(t,"a",function(){return a}),e.d(t,"b",function(){return o})},"2d47":function(n,t,e){"use strict";var a=e("9704"),o=e.n(a);o.a},"6cc1":function(n,t,e){"use strict";e.r(t);var a=e("200b"),o=e("ebaa");for(var u in o)"default"!==u&&function(n){e.d(t,n,function(){return o[n]})}(u);e("2d47");var c=e("2877"),r=Object(c["a"])(o["default"],a["a"],a["b"],!1,null,null,null);t["default"]=r.exports},8026:function(n,t,e){"use strict";(function(n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var e={data:function(){return{login:!1,avatarUrl:"../../../static/img/logo.png",uerInfo:{}}},methods:{goLogin:function(){this.login?n.showModal({title:"重新登录",content:"确定要重新登录吗?",showCancel:!0,cancelText:"取消",confirmText:"去登录",success:function(t){t.confirm&&(n.removeStorageSync("user"),n.reLaunch({url:"../../login/login"}))},fail:function(){},complete:function(){}}):n.navigateTo({url:"../../login/login"})},xmfauth:function(t){n.navigateTo({url:"../../xmfauth/xmfauth"})}},onShow:function(){var t=this;try{n.getStorage({key:"user",success:function(n){n.data&&(t.login=!0,t.uerInfo.name=n.data)}})}catch(e){}}};t.default=e}).call(this,e("6e42")["default"])},9704:function(n,t,e){},ebaa:function(n,t,e){"use strict";e.r(t);var a=e("8026"),o=e.n(a);for(var u in a)"default"!==u&&function(n){e.d(t,n,function(){return a[n]})}(u);t["default"]=o.a}},[["dee9","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/reg/reg"],{2731:function(t,e,n){"use strict";n.r(e);var o=n("a13b"),i=n.n(o);for(var a in o)"default"!==a&&function(t){n.d(e,t,function(){return o[t]})}(a);e["default"]=i.a},"51f6":function(t,e,n){"use strict";var o=n("e841"),i=n.n(o);i.a},a0c7:function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return i})},a13b:function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;o(n("3b98"));function o(t){return t&&t.__esModule?t:{default:t}}var i=function(){return n.e("components/m-input").then(n.bind(null,"4fdb"))},a={components:{mInput:i},data:function(){return{isActive:!1,vcodetxt:"获取验证码",account:"",password:"",email:"",vcode:""}},methods:{register:function(){if(11==this.account.length)if(this.password.length<6)t.showToast({icon:"none",title:"密码最短为 6 个字符"});else if(this.email.length<3||!~this.email.indexOf("@"))t.showToast({icon:"none",title:"邮箱地址不合法"});else if(4==this.vcode.length){var e={account:this.account,password:this.password,email:this.email,vcode:this.vcode},n=this.webUrl+"/Washapp/Reg/Toreg";t.request({url:n,method:"POST",header:{"Content-Type":"application/x-www-form-urlencoded"},data:{phone:e.account,passwd:e.password,vercode:e.vcode,email:e.email},dataType:"json",success:function(e){0==e.data.code?(t.showToast({icon:"none",duration:2e3,title:e.data.msg}),t.navigateBack({delta:1})):t.showModal({title:"错误",content:JSON.stringify(e)})},fail:function(e){t.showToast({icon:"none",title:"注册失败！"+JSON.stringify(e)})}})}else t.showToast({icon:"none",title:"验证码输入错误"});else t.showToast({icon:"none",title:"手机号为 11 个字符"})},getvcode:function(){var e=this;if(1!=e.isActive)if(11==this.account.length){var n=60;this.isActive=!0;var o=this.webUrl+"/Washapp/Vercode/getvercode";t.request({url:o,method:"POST",header:{"Content-Type":"application/x-www-form-urlencoded"},data:{phone:e.account},dataType:"json",success:function(e){t.showToast({icon:"none",title:e.msg})},fail:function(){t.showToast({icon:"none",title:"验证码发送失败"})},complete:function(){var t=setInterval(function(){e.vcodetxt=n+"(s)",0==n&&(e.vcodetxt="获取验证码",clearInterval(t),e.isActive=!1),n--},1e3)}})}else t.showToast({icon:"none",title:"手机号为 11 个字符"})}}};e.default=a}).call(this,n("6e42")["default"])},e841:function(t,e,n){},f605:function(t,e,n){"use strict";n.r(e);var o=n("a0c7"),i=n("2731");for(var a in i)"default"!==a&&function(t){n.d(e,t,function(){return i[t]})}(a);n("51f6");var s=n("2877"),c=Object(s["a"])(i["default"],o["a"],o["b"],!1,null,null,null);e["default"]=c.exports}},[["1103","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/pwd/pwd"],{9287:function(n,t,e){"use strict";var u=function(){var n=this,t=n.$createElement;n._self._c},o=[];e.d(t,"a",function(){return u}),e.d(t,"b",function(){return o})},9631:function(n,t,e){},"97a9":function(n,t,e){"use strict";var u=e("9631"),o=e.n(u);o.a},"9f9a":function(n,t,e){"use strict";(function(n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;u(e("3b98"));function u(n){return n&&n.__esModule?n:{default:n}}var o=function(){return e.e("components/m-input").then(e.bind(null,"4fdb"))},a={components:{mInput:o},data:function(){return{email:""}},methods:{findPassword:function(){this.email.length<3||!~this.email.indexOf("@")?n.showToast({icon:"none",title:"邮箱地址不合法"}):n.showToast({icon:"none",title:"已发送重置邮件至注册邮箱，请注意查收。",duration:3e3})}}};t.default=a}).call(this,e("6e42")["default"])},cef6:function(n,t,e){"use strict";e.r(t);var u=e("9287"),o=e("db61");for(var a in o)"default"!==a&&function(n){e.d(t,n,function(){return o[n]})}(a);e("97a9");var i=e("2877"),r=Object(i["a"])(o["default"],u["a"],u["b"],!1,null,null,null);t["default"]=r.exports},db61:function(n,t,e){"use strict";e.r(t);var u=e("9f9a"),o=e.n(u);for(var a in u)"default"!==a&&function(n){e.d(t,n,function(){return u[n]})}(a);t["default"]=o.a}},[["008c","common/runtime","common/vendor"]]]);
});
...
__wxRoute = 'pages/xmfauth/xmfauth';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/xmfauth/xmfauth.js';

define('pages/xmfauth/xmfauth.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/xmfauth/xmfauth"],{1581:function(a,t,e){"use strict";e.r(t);var n=e("b48b"),i=e.n(n);for(var o in n)"default"!==o&&function(a){e.d(t,a,function(){return n[a]})}(o);t["default"]=i.a},"4f9e":function(a,t,e){"use strict";var n=function(){var a=this,t=a.$createElement;a._self._c},i=[];e.d(t,"a",function(){return n}),e.d(t,"b",function(){return i})},6196:function(a,t,e){"use strict";var n=e("651c"),i=e.n(n);i.a},"651c":function(a,t,e){},"7b0a":function(a,t,e){"use strict";e.r(t);var n=e("4f9e"),i=e("1581");for(var o in i)"default"!==o&&function(a){e.d(t,a,function(){return i[a]})}(o);e("6196");var c=e("2877"),s=Object(c["a"])(i["default"],n["a"],n["b"],!1,null,null,null);t["default"]=s.exports},b48b:function(a,t,e){"use strict";(function(a){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;new Array;var e,n=";",i={data:function(){return{idCard1:"../../static/imgs/idcard1.png",idCard2:"../../static/imgs/idcard2.png",washCar:"../../static/logo.png"}},onLoad:function(){e=this},onShow:function(){try{n=a.getStorageSync("user"),""==n&&a.showModal({title:"",content:"用户未登录，不能进行认证",showCancel:!1,cancelText:"取消",confirmText:"去登录",success:function(t){t.confirm?a.reLaunch({url:"../login/login"}):t.cancel&&a.reLaunch({url:"../tabbar/tabbar-3/my"})},fail:function(){},complete:function(){}})}catch(t){console.log(t," at pages\\xmfauth\\xmfauth.vue:89")}},methods:{selectImg1:function(){a.chooseImage({count:1,success:function(a){e.idCard1=a.tempFilePaths[0]}})},selectImg2:function(){a.chooseImage({count:1,success:function(a){e.idCard2=a.tempFilePaths[0]}})},selectImg3:function(){a.chooseImage({count:1,success:function(a){e.washCar=a.tempFilePaths[0]}})},previewImg1:function(){a.previewImage({urls:[e.idCard1]})},previewImg2:function(){a.previewImage({urls:[e.idCard2]})},previewImg3:function(){a.previewImage({urls:[e.washCar]})},uploadCards:function(){var t="",i="",o="";if("../../static/imgs/idcard1.png"!=this.idCard1&&"../../static/imgs/idcard2.png"!=this.idCard2){a.showLoading({title:"上传中"}),[];var c=this.webUrl+"/Washapp/Main/outhupload";a.uploadFile({url:c,filePath:e.idCard1,fileType:"image",name:"data",success:function(s){var u=JSON.parse(s.data),r=u.data.savepath+u.data.savename;t=r;a.uploadFile({url:c,filePath:e.idCard2,fileType:"image",name:"data",success:function(s){var u=JSON.parse(s.data),r=u.data.savepath+u.data.savename;i=r;a.uploadFile({url:c,filePath:e.washCar,fileType:"image",name:"data",success:function(c){var s=JSON.parse(c.data),u=s.data.savepath+s.data.savename;o=u;var r=e.webUrl+"/Washapp/Main/submitouth";a.request({url:r,method:"POST",header:{"Content-Type":"application/x-www-form-urlencoded"},dataType:"json",data:{user:n,ID1:t,ID2:i,washpic:o},success:function(t){0==t.data.code?(plus.nativeUI.toast("审核信息提交成功，请等待审核"),a.reLaunch({url:"../tabbar/tabbar-3/my"})):a.showModal({title:"提交错误",content:t.data.msg,showCancel:!1,cancelText:"取消",confirmText:"确定",success:function(a){}})},fail:function(t){a.showToast({title:"信息提交异常:"+JSON.stringify(t),icon:"none"})},complete:function(t){a.hideLoading()}})},fail:function(t){a.showToast({title:"洗车机照片上传失败",icon:"none",duration:2e3}),a.hideLoading()}})},fail:function(){a.showToast({title:"身份证背面照片上传失败",icon:"none",duration:2e3}),a.hideLoading()}})},fail:function(){a.showToast({title:"身份证正面照片上传失败",icon:"none",duration:2e3}),a.hideLoading()}})}else a.showToast({title:"请选择身份证照片",icon:"none"})}}};t.default=i}).call(this,e("6e42")["default"])}},[["93e0","common/runtime","common/vendor"]]]);
});
require('pages/xmfauth/xmfauth.js');
;(function(global) {
