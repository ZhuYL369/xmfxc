<template>
	<view class="index" v-bind:style="[{'min-height': secondHeight + 'px' }]">
			...
			<view class="scan-item">
				<view class="scan-content">
					<view class="scan-icon">
						<image src="../../../static/img/icon-scan.png" class="scan-icon-img"></image>
					</view>
					<image src="../../../static/img/fork.png" class="scan-btn" @click="cancelEvent"></image>
		...
		<view class="btn-plusempty" hover-class="bottom-btn-hover" @click="addCustomer">
			<image src="../../../static/img/jiahao.png" class="plusempty-img"></image>
		</view>
	</view>
</template>
	...
	export default {
		...
		onShow() {
			...
			uni.onWindowResize((res) => {
				if(res.size.windowHeight<that.secondHeight){
					uni.hideTabBar({
						animation:false
					})
				}
				if(res.size.windowHeight>420){
					uni.showTabBar({
						animation:false
					})
				}
